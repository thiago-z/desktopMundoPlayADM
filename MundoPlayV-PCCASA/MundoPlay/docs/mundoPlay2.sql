-- TABELA COM CHAVES PRIMARIAS TROCADAS PARA TESTE
...
CREATE TABLE game_diretor (
  ...
  FOREIGN KEY (game) REFERENCES games(idgames) ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY (diretor) REFERENCES diretores(nomeDiretor) ON DELETE CASCADE ON UPDATE CASCADE
)
...
CREATE TABLE game_genero (
  ...
  FOREIGN KEY (game) REFERENCES games(idgames) ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY (genero) REFERENCES generos(nomegenero) ON DELETE CASCADE ON UPDATE CASCADE
)
...
CREATE TABLE filme_pais (
  ...
  FOREIGN KEY (filme) REFERENCES filmes(idfilmes) ON DELETE CASCADE ON UPDATE CASCADE,
  FOREIGN KEY (pais) REFERENCES paises(nomePais) ON DELETE CASCADE ON UPDATE CASCADE
)
